...
contract SuperswapV1Pair is IUniswapV2Pair, SuperswapV1ERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, 'SuperswapV1: LOCKED');
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function initialize(address _token0, address _token1) external override {
        require(msg.sender == factory, 'SuperswapV1: FORBIDDEN'); // sufficient check
        token0 = _token0;
        token1 = _token1;
    }
