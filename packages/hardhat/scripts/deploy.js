...
const main = async () => {
  ...
  const superswap = await deploy("SuperswapV1ERC20"); // <-- add in constructor args like line 19 vvvv
  const superswapPair = await deploy("SuperswapV1Pair"); // <-- add in constructor args like line 19 vvvv
